...
// in simulator we redefine to format for notice_view Developer console
...
{\
	NSString * exceptionName = [@"org.notice_view." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.notice_view";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UInotice_viewNativeItemNone = -1, 
	UInotice_viewNativeItemSpinner = -2,
	UInotice_viewNativeItemProgressBar = -3,
	
	UInotice_viewNativeItemSlider = -4,
	UInotice_viewNativeItemSwitch = -5,
	UInotice_viewNativeItemMultiButton = -6,
	UInotice_viewNativeItemSegmented = -7,
	
	UInotice_viewNativeItemTextView = -8,
	UInotice_viewNativeItemTextField = -9,
	UInotice_viewNativeItemSearchBar = -10,
	
	UInotice_viewNativeItemPicker = -11,
	UInotice_viewNativeItemDatePicker = -12,
	
	UInotice_viewNativeItemInfoLight = -13,
	UInotice_viewNativeItemInfoDark = -14,
	
	UInotice_viewNativeItemDisclosure = -15,
	
	UInotice_viewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all notice_view instances of
