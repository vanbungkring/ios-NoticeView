...
@interface notice_viewObject : KrollCoverageObject {
#else
@interface notice_viewObject : KrollObject {
#endif
@private
...
extern NSString * notice_view$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	notice_viewObject *_notice_view;
	BOOL shutdown;
