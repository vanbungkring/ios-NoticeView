 ...
 * Copyright (c) 2009-2011 by notice_view, Inc. All Rights Reserved.
...
//@interface notice_viewObject : NSObject
//@end

@interface notice_viewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[notice_viewObject class]])
		{
			for (NSString *key in [[(notice_viewObject*)o modules] allKeys])
			{
