...
/**
 The base class for all notice_view modules
 */
...
/**
 notice_view Platform calls this method on startup.
 */
-(void)startup;

/**
 notice_view Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 notice_view Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 notice_view Platform calls this method on resume.
 @param sender The sender of the event.
 */
